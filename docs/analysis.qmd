...
for systeme in systemes_production:
    ...
    forecast_conf_int = forecast.conf_int(alpha = 0.05) # fixe l'intervalle à 95%
    ...
    plt.fill_between(sarima_forecast.index, forecast_conf_int.iloc[:, 0], forecast_conf_int.iloc[:, 1], color='pink', alpha=0.3, label=f'{systeme} 95% Confidence Interval')
