...
# Plotting annual sales as a bar plot
ggplot(sales_data, aes(x = reorder(Location, -`2023`), y = `2023`)) +
  geom_bar(stat = "identity", fill = "skyblue", color = "black") +
  labs(x = "Location", y = "Annual Sales", title = "Annual Sales by Location (2023)") +
