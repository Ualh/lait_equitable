...
plt.legend(title='Système de production', bbox_to_anchor=(1.05, 1), loc='upper left')  # Add a legend 
plt.grid(True, which='both', linestyle='--', linewidth=0.5)
plt.xticks(rotation=45) 
...
Regions 5 and 3 have not produced organic milk since 2001. Region 3 has lower milk production than the other regions 
